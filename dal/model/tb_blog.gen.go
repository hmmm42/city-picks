...
type TbBlog struct {
	...
	Liked      uint64    `gorm:"column:liked;type:int unsigned;comment:点赞数量" json:"liked"`                                             // 点赞数量
	Comments   uint64    `gorm:"column:comments;type:int unsigned;comment:评论数量" json:"comments"`                                       // 评论数量
