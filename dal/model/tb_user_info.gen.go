...
type TbUserInfo struct {
	...
	Fans       uint64    `gorm:"column:fans;type:int unsigned;comment:粉丝数量" json:"fans"`                                               // 粉丝数量
	Followee   uint64    `gorm:"column:followee;type:int unsigned;comment:关注的人的数量" json:"followee"`                                    // 关注的人的数量
	Gender     uint8     `gorm:"column:gender;type:tinyint unsigned;comment:性别，0：男，1：女" json:"gender"`                                 // 性别，0：男，1：女
	Birthday   time.Time `gorm:"column:birthday;type:date;comment:生日" json:"birthday"`                                                 // 生日
	Credits    uint64    `gorm:"column:credits;type:int unsigned;comment:积分" json:"credits"`                                           // 积分
	Level      uint8     `gorm:"column:level;type:tinyint unsigned;comment:会员级别，0~9级,0代表未开通会员" json:"level"`                           // 会员级别，0~9级,0代表未开通会员
